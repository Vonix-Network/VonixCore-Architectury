...
public class AdvancementEmbedDetector {
     ...
     * @return true if the embed is identified as an advancement embed, false otherwise
     */
    public boolean isAdvancementEmbed(Embed embed) {
        ...
        try {
            ...
            VonixCore.LOGGER.warn("[Discord] Error during advancement embed detection, treating as non-advancement embed. " +
     ...
     * 
     * @param embed The Discord embed to analyze
     * @return The corresponding AdvancementType, defaults to NORMAL if not recognized
     */
    public AdvancementType getAdvancementType(Embed embed) {
        ...
        try {
            ...
            try {
                ...
                VonixCore.LOGGER.debug("[Discord] Error checking embed title for advancement type: {}", 
            ...
            try {
                ...
                VonixCore.LOGGER.debug("[Discord] Error checking embed footer for advancement type: {}", 
    ...
    private boolean hasAdvancementFooter(Embed embed) {
        try {
            ...
            try {
                ...
                if (VonixCore.LOGGER.isDebugEnabled() && hasKeyword) {
                    VonixCore.LOGGER.debug("[Discord] Advancement embed detected by footer keywords. " +
                ...
                VonixCore.LOGGER.warn("[Discord] Error accessing footer text for advancement detection: {}", 
                        footerTextError.getMessage());
                return false;
            }
            
        } catch (Exception e) {
            VonixCore.LOGGER.warn("[Discord] Error checking embed footer for advancement keywords: {}", 
                    e.getMessage());
            return false;
        }
    }
