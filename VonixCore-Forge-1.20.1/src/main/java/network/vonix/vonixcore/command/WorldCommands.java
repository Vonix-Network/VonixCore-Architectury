...
public class WorldCommands {
    ...
    private static int lightningAtPlayer(CommandContext<CommandSourceStack> ctx) {
        ...
        var lightning = net.minecraft.world.entity.EntityType.LIGHTNING_BOLT.create(player.serverLevel());
        if (lightning != null) {
    ...
    private static int lightningAtTarget(CommandContext<CommandSourceStack> ctx, ServerPlayer target) {
        var lightning = net.minecraft.world.entity.EntityType.LIGHTNING_BOLT.create(target.serverLevel());
        if (lightning != null) {
